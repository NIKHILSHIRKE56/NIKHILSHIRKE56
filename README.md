...
- 🌍 Contribute to enterprise-grade open-source tools  
...
### 🏋️ [Kinetix – Computer Vision Fitness App](https://kinetix.co.in)
Mobile and web application tracking exercise form and counting repetitions using Flutter, OpenCV, MediaPipe, WebSockets, and Supabase.
...
- 🎓 11+ years in QA, Linux, and infrastructure engineering  
...
- 🛠️ Currently building real-world AI tools like **SHEye** and **Kinetix**
